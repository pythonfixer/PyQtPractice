...
class MainWindow(QMainWindow):
    ...
    def updateUi(self, arg=None):
        ...
        self.editIndentAction.setEnabled(not self.editor.document().isEmpty())
        self.editUnindentAction.setEnabled(not self.editor.document().isEmpty())
    ...
    def loadFile(self):
        ...
        try:
            ...
            self.setWindowTitle("Python Editor - {}".format(QFileInfo(self.filename).fileName()))
        except EnvironmentError as e:
            QMessageBox.warning(self, "Python Editor -- Load Error", "Failed to load {}: {}".format(self.filename, e))
        finally:
            if fh is not None:
                fh.close()
