...
class AddEditMovieDlg(QDialog,
        ui_addeditmoviedlg_ans.Ui_AddEditMovieDlg):
    ...
    def __init__(self, movies, movie=None, parent=None):
        ...
        self.acquiredDateEdit.setDisplayFormat(moviedata_ans.DATEFORMAT)
    ...
    def accept(self):
        ...
        if self.movie is None:
            ...
            #acquired, notes)
            self.movie = moviedata_ans.Movie(title, year, minutes, acquired, location, notes)
