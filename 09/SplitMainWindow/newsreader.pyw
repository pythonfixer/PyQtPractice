...
class MainWindow(QMainWindow):
    ...
    def createMenusAndToolbars(self):
        ...
        for icon, text in (("new", "&New..."), ("open", "&Open..."), ("save", "&Save"), ("save", "Save &As..."), (None, None), ("quit", "&Quit")):
            if icon is None:
                fileMenu.addSeparator()
            else:
                action = QAction(QIcon(":/file{}.png".format(icon)), text, self)
                if icon == "quit":
        ...
        for icon, text in (("add", "&Add..."), ("edit", "&Edit..."), ("delete", "&Remove")):
            action = QAction(QIcon(":/edit{}.png".format(icon)), text, self)
